...
// payment/ready
export const postPaymentReady = async (lectureItem:LectureItem): Promise<paymentData> => {
  try {
...
// /payment/list/ready
export const postPaymentBundleReady = async (lectureItems:LectureItem[]): Promise<paymentData> =>{
  try {
